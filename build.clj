...
(def lib 'com.sturdystats/roughtime-protocol)
...
(defn jar
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    :src-dirs  ["src"]
    :pom-data
    [[:description "Clojure implementation of the RoughTime protocol."]
     [:url "https://github.com/Sturdy-Statistics/roughtime-protocol"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/roughtime-protocol"]
      [:connection "scm:git:https://github.com/Sturdy-Statistics/roughtime-protocol.git"]]]})
